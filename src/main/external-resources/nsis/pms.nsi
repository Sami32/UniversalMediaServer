...
; http://nsis.sourceforge.net/Examples/makensis.nsi
...
; http://nsis.sourceforge.net/New_installer_with_JRE_check_(includes_fixes_from_%27Simple_installer_with_JRE_check%27_and_missing_jre.ini)
;-----------------------------------------------------------------------
